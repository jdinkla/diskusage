...
/**
	Unit test for class TreeNode
*/

class TreeNodeTest extends GroovyTestCase {

	private TreeNode n1, n2, n3
	
	void setUp() {
		n1 = new TreeNode(name: '/test1/test2/test3', size: 100, isDirectory: true)
		n2 = new TreeNode(name: 'a.txt',size: 123)
		n3 = new TreeNode(name: 'b.txt', size: 234)
		n1.add(n2)
		n1.add(n3)
	}
